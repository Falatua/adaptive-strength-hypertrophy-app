# ForgePath Private Alpha 0.29.0
...
- 183 deterministic domain tests
...
- version 20 backup and restore includes missed-opportunity decisions, athlete-reviewed plan-route and exact-movement criterion-exit decisions, self-contained replayable assessments, exact-history placement evidence, per-movement placement, equipment-aware route-generation snapshots, productive verification events, source-linked first-set evidence, recovery responses, equipment profiles, plan history, ledgers, survey evidence, and safely migrates versions 1 through 19
...
- missed-opportunity-v3 validates automatic choices and athlete pins against the active equipment profile, protected-primary joint response, and global placement safety gate; unavailable support work is removed with replayable evidence rather than left as impossible prescription
