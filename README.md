# ForgePath Private Alpha 0.62.1
...
- version 26 backup and restore includes exact-movement workout notes, entered-number provenance, source-backed priority-region dose, missed-opportunity equipment and readiness decisions, athlete-reviewed plan-route and exact-movement criterion-exit decisions, self-contained replayable assessments, exact-history placement evidence, per-movement placement, equipment-aware route-generation snapshots, productive verification events, source-linked first-set evidence, recovery responses, equipment profiles, plan history, ledgers, survey evidence, and safely migrates versions 1 through 25
