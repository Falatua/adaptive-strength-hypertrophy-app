...
if (!javascript.includes('Log in with email') || !javascript.includes('shouldCreateUser')) failures.push('The public artifact is missing the invitation-only email login path.')
