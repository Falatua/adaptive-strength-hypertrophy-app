...
- Total requirement headings: 354.
- Sequential range: R-001 through R-354.
...
Private alpha 0.35.0 is the current verified implementation boundary. Evidence is recorded in [[Private Alpha Implementation 2026-08-10]], [[UX Audit 2026-08-10]], [[Functional UX Audit 2026-08-10]], and [[Adaptive Strength and Hypertrophy App Build Bible#74. Functional UX Integrity and Cross-Device Workflow Contract]]. Version 0.35.0 adds real Library category and filter piping, touch-safe workout reasoning, active-workout leave and resume, real unresolved-session priority mutation, cross-device target hardening, and aligned release metadata. Verification includes 191 deterministic tests across twenty files, fifty-two Playwright journeys across desktop and phone, a production PWA build, production Lighthouse 100/100/100 desktop and 98/100/100 mobile, accessibility and static UI scans, zero console errors, zero high dependency vulnerabilities, a clean secret scan, and responsive sweeps from 320-pixel phone through desktop. All verified 0.34.0 and earlier training-engine evidence remains active, including `field-guide-synth-v1`, `schedule-priority-dose-v1`, backup schema version 24, and local persistence version 22. R-331 through R-340 and Chapter 72 capture the new hypertrophy policy and template source, but selectable failure-target double progression, per-exercise increments, and upper-lower templates remain unimplemented. R-341 through R-346 and Chapter 73 govern the cross-device task-focus changes. R-347 through R-354 and Chapter 74 govern functional control integrity. Personal readiness baselines, fixed-event pressure, downstream-fatigue interaction, complete later-session substitution, contextual preferences, companion progression, cloud sync, and the new hypertrophy-policy controls remain incomplete.
...
| R-312 to R-319 | Phone and laptop parity, one account, local-first cloud sync, workout handoff, honest status, conflict preservation, recovery, and release gate | 19, 20, 21, 24, 27, 68 | [[Data Backend Storage and Learning Architecture]] | 1A to 3 | Responsive parity, offline outbox, sync idempotency, lease takeover, conflict, hydration, RLS, recovery, and cross-device acceptance tests |
