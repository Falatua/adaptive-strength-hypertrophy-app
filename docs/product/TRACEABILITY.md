...
- Total requirement headings: 324.
- Sequential range: R-001 through R-324.
...
Private alpha 0.32.0 is the current verified implementation boundary. Evidence is recorded in [[Private Alpha Implementation 2026-08-10]] and [[Adaptive Strength and Hypertrophy App Build Bible#70. Context-Grounded Product Craft and Training Field Guide]]. Version 0.32.0 adds repository-local product and design registers, an original evidence-backed Today Training Field Guide, post-onboarding focus handoff, and a sixty-two-file automated UI boundary gate. The guide projects the existing route and progression engine and has no programming authority of its own. Verification includes 189 deterministic tests across nineteen files, forty-six Playwright journeys across desktop and phone, a production PWA build, and full-resolution 390 by 844 visual review. All verified 0.31.0 and earlier training-engine evidence remains active, including `schedule-priority-dose-v1`, backup schema version 24, and local persistence version 22. R-296 through R-303 and Chapter 66 specify the original evolving training companion, but this deeper game layer is not implemented. R-304 through R-311 and Chapter 67 specify five-state and contextual exercise preferences. R-312 through R-319 and Chapter 68 specify phone-laptop cloud convergence; responsive operation exists but authentication and synchronization do not. R-320 and Chapter 69 exclude athlete-facing technique videos. R-321 through R-324 and Chapter 70 govern context-grounded product judgment, original handheld craft, durable design context, and UI QC. Personal readiness baselines, fixed-event pressure, downstream-fatigue interaction, complete later-session substitution, contextual preferences, companion progression, and cloud sync remain incomplete.
