...
The first working implementation is documented in [[Private Alpha Implementation 2026-08-10]]. It uses the provisional name ForgePath Private Alpha, lives at `/Users/redsky/Projects/adaptive-strength-hypertrophy-app`, and is preserved in the private GitHub repository `Falatua/adaptive-strength-hypertrophy-app`. The verified baseline commit is `61cc63f`.
