...
The code is preserved in the private GitHub repository `Falatua/adaptive-strength-hypertrophy-app`. Releases 0.1.0 through 0.30.0 remain in Git history. Private alpha 0.30.0 is commit `b204c54342a08366f8026e305171993ffb27aee7` and adds fresh readiness evidence without penalizing missing or stale answers. Private alpha 0.31.0 is commit `06336129e7c2952e4645e088fbc0b4c8479208cf` and adds source-backed relative priority-region dose as a bounded schedule tie-break. Local and remote `main` match exactly and the worktree is clean. Dependency audit reported zero vulnerabilities. Gitleaks scanned the full repository and found no leaks. Diff whitespace validation passed.
