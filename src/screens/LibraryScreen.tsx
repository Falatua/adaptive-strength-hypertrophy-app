...
export function LibraryScreen() {
  ...
  const [editValues, setEditValues] = useState({ load: '', reps: '', rir: '', technique: '', pain: '', completedAt: '', reason: '' })
