    ...
    <div className="screen">
      ...
      <div className="settings-layout" id="you-training">
        ...
        <aside className="settings-aside" id="you-account">
          ...
          <section className="panel"><div className="panel__header"><div><p className="eyebrow">System versions</p><h3>Diagnostics</h3></div><Database size={19} /></div><ul className="diagnostic-list"><li><span>App</span><strong>0.75.0 private alpha</strong></li><li><span>Rules</span><strong>0.75.0 slower Forge levels · readiness-gated repetitions · Home Gym preference v3</strong></li><li className="diagnostic-list__wide"><span>Calculations</span><details><summary>Rule versions behind the numbers</summary><p>Placement v3 · Movement placement v2 · Placement history v1 · Placement verification v1 · Placement exit v1 · Movement placement exit v1 · Ongoing confidence v1 · Life-aware review v1 · Route session v4 · Repetition readiness v1 · Progression v2 · Effort metric v1 · Set entry autofill v1 · Set structure v1 · Volume progression v2 · Deload v1 · Athlete level v2 · Training split v1 · Structure progression v1 · Missed opportunity v5 · Schedule eligibility v1 · Schedule readiness v1 · Schedule priority dose v1 · Calendar exposure v1 · Volume v2 · PR v2 · Plan dose v1 · Muscle dose v1 · Movement notes v1 · Session extension v1 · Equipment v1 · Load increment v1 · Catalog merge v1 · History entry v1 · Sound pack field-guide-synth-v1</p></details></li><li><span>Backup version</span><strong>Version 29</strong></li><li><span>Persistence</span><strong>{cloudAuthoritativeBuild ? 'Supabase snapshot v1 · pending recovery copy only' : 'Local test state v30'}</strong></li><li><span>Cloud</span><strong>{cloudConfiguration.status === 'ready' ? 'Authenticated and account-scoped' : 'Private release gate closed'}</strong></li><li><span>AI provider</span><strong>Not required at runtime</strong></li></ul></section>
