    ...
    <div className="screen">
      ...
      <div className="settings-layout">
        ...
        <aside className="settings-aside">
          ...
          <section className="panel"><div className="panel__header"><div><p className="eyebrow">System versions</p><h3>Diagnostics</h3></div><Database size={19} /></div><ul className="diagnostic-list"><li><span>App</span><strong>0.14.0 private alpha</strong></li><li><span>Rules</span><strong>0.14 load-first + import identity v1</strong></li><li><span>Calculations</span><strong>Volume v2 · PR v2 · Dose v1</strong></li><li><span>Backup schema</span><strong>Version 10</strong></li><li><span>Persistence</span><strong>Local v8</strong></li><li><span>Cloud sync</span><strong>Not connected</strong></li><li><span>AI provider</span><strong>Not required</strong></li></ul></section>
